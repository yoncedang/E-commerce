...
export default function initModels(sequelize) {
  ...
  checkout.belongsTo(discount, { as: "discount", foreignKey: "discount_id"});
  discount.hasMany(checkout, { as: "checkouts", foreignKey: "discount_id"});
  orderHistory.belongsTo(discount, { as: "discount", foreignKey: "discount_id"});
  discount.hasMany(orderHistory, { as: "orderHistories", foreignKey: "discount_id"});
