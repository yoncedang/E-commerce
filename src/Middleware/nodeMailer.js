...
const SendLinkVerification = async (email, verificationToken, code) => {
     try {
          ...
          const transporter = nodemailer.createTransport({
               ...
               auth: {
                    user: "huydang.dev@gmail.com", // Your email address
                    pass: "knxyamkwccxaifvn", // Your email password or application-specific password
               },
          });

          // Email content
          const mailOptions = {
               from: 'huydang.dev@gmail.com', // Địa chỉ email người gửi
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a class="button" href="http://localhost:8080/api/auth/verify-email?token=${verificationToken}">Xác nhận đăng ký</a>
...
const SendLinkRetsetPassword = async (email, verificationToken, code) => {
  try {
       // Create a Nodemailer transporter
       const transporter = nodemailer.createTransport({
            host: "smtp.gmail.com", // Replace with the SMTP server hostname (e.g., smtp.gmail.com for Gmail)
 ...
 <body>
   <div class="container">
     ...
     <div class="content">
       <p>Vui lòng click vào liên kết dưới đây để xác nhận đăng ký tài khoản:</p>
       <a class="button" href="http://localhost:8080/api/auth/reset-password?token=${verificationToken}">Xác nhận đăng ký</a>
       <h1>Verification Code is: ${code}</h1>
 ...
 <body>
   <div class="container">
     ...
     <div class="content">
       ...
       <a class="button" href="http://localhost:8080/api/auth/login">Đăng nhập</a>
